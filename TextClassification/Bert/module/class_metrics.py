...
class ClassEvaluator(object):
    ...
    def compute(self, round_num=2) -> dict:
        ...
        res['precision'] = round(precision_score(self.goldens, self.predictions, average='macro'), round_num)
        res['recall'] = round(recall_score(self.goldens, self.predictions, average='macro'), round_num)
        res['f1'] = round(f1_score(self.goldens, self.predictions, average='macro'), round_num)
